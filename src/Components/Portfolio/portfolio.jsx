        ...
        <div className="container_right">
          <div className="aboutMe">
            ...
            <ul className="certificados">
              ...
              <li>
                <h2 className="ola">The Complete Python Bootcamp From Zero to Hero in Python (Udemy)</h2>
                <p>
                  Conceptos básicos de Python como tipos de datos (listas, diccionarios, tuples, etc.), estructuras de control, 
                  hasta temas más avanzados como POO, analisis de archivos (PDFs, CSVs), 
                  envío y recepción de mails y Web Scraping.
                </p>
                <a href="https://www.udemy.com/certificate/UC-0d521c32-13c7-4f60-b63d-fc5bb9836b10/" target="_blank">
                  Mostrar credencial
                </a>
              </li>
            ...
            <ul className="lproyectol">
              ...
              <li>
                <h2 className="appClima"><a href="https://maxisanchezp.github.io/rpgGame/" target="blank">Juego RPG</a></h2>
                  <p>
                  Desarrollado simplemente con JavaScript como parte de un ejercicio práctico de lógica en la pagina de FreeCodeCamp
                  </p>
              </li>
            </ul>
          </div>
